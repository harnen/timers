...
#ifndef NFD_DAEMON_FW_PATH_SWITCHING_STRATEGY_HPP
#define NFD_DAEMON_FW_PATH_SWITCHING_STRATEGY_HPP
 ...
 */
class PathSwitchingStrategy : public Strategy
{
public:
  explicit
  PathSwitchingStrategy(Forwarder& forwarder, const Name& name = STRATEGY_NAME);
...
#endif // NFD_DAEMON_FW_PATH_SWITCHING_STRATEGY_HPP
